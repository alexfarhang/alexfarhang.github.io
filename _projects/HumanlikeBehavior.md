...
Companion page for *Humanlike Behavior in a Third-Person Shooter with Imitation Learning*<d-cite key="farhang2024Humanlike"></d-cite> ([pdf](assets/pdf/Humanlike_Behavior.pdf)), presented in August 2024 at the [IEEE Conference on Games (CoG) in Milan](https://2024.ieee-cog.org).
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/NN_architecture_ID.png" title="NN architecture" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
